...
- Name: acceptance.spec.ts >> a canvas any Nextly editor could ship >> resolves a pointer collision to the innermost container
- Location: acceptance.spec.ts:119:3
