 ...
 *    stopped being legible. It is now 0.545 (light) / 0.70 (dark), which is a
 *    visible step firmer and still the quietest text in the palette.
 ...
 *    from the space around it. They now clear 3:1. `border-subtle` is
...
export const CALM: ThemeDefinition = {
  ...
  light: {
    ...
    "muted-foreground": "oklch(0.545 0.012 260)",
    ...
    destructive: "oklch(0.57 0.13 22)",
    "destructive-solid": "oklch(0.56 0.17 22)",
    "destructive-foreground": "oklch(1 0 0)",
    success: "oklch(0.54 0.09 155)",
    ...
    "code-comment": "oklch(0.53 0.01 260)",
    ...
    "code-punctuation": "oklch(0.53 0.01 260)",
    ...
    border: "oklch(0.45 0.01 260 / 0.45)",
    "border-strong": "oklch(0.45 0.01 260 / 0.70)",
    input: "oklch(0.65 0.006 260)",
  ...
  dark: {
    ...
    "muted-foreground": "oklch(0.70 0.012 262)",
    ...
    destructive: "oklch(0.71 0.12 22)",
    "destructive-solid": "oklch(0.56 0.17 22)",
    ...
    "code-comment": "oklch(0.70 0.012 262)",
    ...
    "code-punctuation": "oklch(0.70 0.012 262)",
    ...
    border: "oklch(1 0 0 / 0.34)",
    "border-strong": "oklch(1 0 0 / 0.48)",
    input: "oklch(0.57 0.012 262)",
    ring: "var(--nx-primary)",
    "focus-ring": "var(--nx-primary)",
    "shadow-color": "oklch(0.12 0.01 262)",
    "sidebar-background": "oklch(0.21 0.008 262)",
    "sidebar-foreground": "oklch(0.8 0.008 262)",
    "sidebar-primary": "oklch(0.78 0.07 250)",
    ...
    "sidebar-border": "oklch(0.52 0.01 262)",
    "sidebar-ring": "var(--nx-primary)",
    "table-border": "var(--nx-border)",
