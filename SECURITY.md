...
If you do not have a GitHub account, send the report to <contact@nextlyhq.com>. Backup-channel reports may be slower to triage than the GitHub flow.

We do not accept reports via Discord / Slack / Twitter DMs.

## What to include

- Affected package(s) (`nextly`, `@nextlyhq/admin`, `@nextlyhq/storage-s3`, etc.) and version(s).
