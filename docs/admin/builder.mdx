...
A Component field embeds a reusable component definition (created via the Components Builder or `defineFieldGroup()`). It can target a single component or a list of allowed components, and can be marked repeatable to act as an inline content zone.
