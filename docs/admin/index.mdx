...
| Builder | `/admin/builder/collections` | Schema management for Collections / Singles / Components — the [Visual Schema Builder](/docs/admin/builder) |
...
The Visual Schema Builder lets you create and edit Collections, Singles, and Field Groups without writing TypeScript. It generates the same artifacts the code-first approach produces. See [Visual Schema Builder](/docs/admin/builder) for the full reference.
