...
`showBuilder` toggles the Builders top-level icon (Collections Builder, Singles Builder, Field Groups Builder) in the admin sidebar.
...
- [Visual Schema Builder](/docs/schema-builder) — what it does and how to use it
