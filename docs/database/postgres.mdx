...
> **Minimum version: PostgreSQL 15.0+.** Older versions hard-fail at connect with a clear upgrade pointer. See [database support](./support) for the full version policy and cloud-provider compatibility.
