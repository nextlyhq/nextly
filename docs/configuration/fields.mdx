...
**Cross-links:** see [Components](/docs/configuration/components) for the `defineFieldGroup()` reference and [the three modes](/docs/configuration/components#using-components-in-collections-and-singles) explained side-by-side.
