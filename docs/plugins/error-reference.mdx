...
| `PLUGIN_UNINSTALL_IRREVERSIBLE` | 409 | A full uninstall needs a migration module that has no DOWN statements for this database's dialect. | Uninstall with `--keep-data`, or ship a DOWN for that module. |
