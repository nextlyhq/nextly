...
| --------- | -------------------------------------------- | --------- | ------ | ---------- | ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **T-015** | Refresh-token UA/IP binding                  | H3        | S      | T-005      | done (`fe0378c`) | Compare stored UA/IP via `getTrustedClientIp`; soft-fail UA, hard-fail on IP-class change.                                                                     |
