...
The user-facing telemetry note lives in the root README, the `create-nextly-app` README, and at [`nextlyhq.com/docs/telemetry`](https://nextlyhq.com/docs/telemetry).
