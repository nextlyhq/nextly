...
import { safeFetch, ExternalUrlError } from "nextly";
...
async function sendWebhook(
  ...
  try {
    ...
    // The webhook URL pointed at an internal / non-public address
    // and was refused before the request left the host. Surface as a
