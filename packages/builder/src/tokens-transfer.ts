...
export function importDtcg(text: string, into: SiteTokenSet): ImportResult {
  ...
  // Everything the file held that this site did not keep is the READER's to say,
  // at the point it passes each part over, so it is carried through whole
  // rather than supplemented by a second look at the same document.
