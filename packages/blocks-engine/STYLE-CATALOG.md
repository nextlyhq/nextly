...
- **dimension** — a CSS length or percentage as a string (`"16px"`, `"2rem"`,
  `"50%"`, `"clamp(1rem, 5vw, 3rem)"`), or the number `0`. Other bare numbers are
  refused: they would emit a unitless value the browser discards.
