...
//
// Seeding is invoked from a project-local auth-gated POST route at
// /admin/api/seed — no longer from the CLI. Schema Builder reintroduction may revisit this.
//
 ...
 */
const BLOG_SEED = `import { container } from "nextly";
 ...
 */
const ECOMMERCE_SEED = `import { container } from "nextly";
