...
export function MaintenancePage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] w-full bg-background p-4">
      {/* Container */}
      <div className="flex flex-col items-center text-center max-w-[500px] w-full px-6 py-12 rounded-2xl bg-white ">
        {/* 503 Big number */}
        ...
        {/* Badge */}
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-amber-50 text-amber-700 mb-6 border border-amber-200/50">
        ...
        <div className="flex items-center justify-center gap-4 w-full sm:w-auto">
          <Button
            variant="outline"
            className="w-full sm:w-[140px] gap-2 rounded-md font-medium text-slate-700 border-slate-200"
