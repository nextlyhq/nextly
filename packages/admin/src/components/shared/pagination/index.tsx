  ...
  (
    ...
    const renderPageNumbers = () => {
      ...
      const renderEllipsis = (key: string) => (
        <span
          key={key}
          className="flex h-8 w-8 items-center justify-center rounded-none  border border-primary/5 bg-background text-muted-foreground text-xs -ml-px"
          aria-hidden="true"
        >
          ...
        </span>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 lg:gap-8 order-1 sm:order-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="relative">
                <select
                  ...
                  disabled={isLoading}
                  className="h-8 w-[70px] appearance-none rounded-none  border border-primary/5 bg-background px-2 py-1 text-sm font-medium focus-visible:outline-none focus:ring-1 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed hover-unified cursor-pointer"
                >
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="hidden sm:flex h-8 w-8 items-center justify-center rounded-none  border border-primary/5 bg-background hover-unified disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring z-10 cursor-pointer"
              aria-label="Go to first page"
            >
            ...
            <button
              ...
              disabled={currentPage === 0 || isLoading}
              className="flex h-8 w-8 items-center justify-center rounded-none  border border-primary/5 bg-background hover-unified disabled:opacity-50 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring z-10"
            ...
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-none  border border-primary/5 bg-background hover-unified disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring z-10"
