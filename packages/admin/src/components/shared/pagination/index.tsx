  ...
  (
    ...
    const renderPageNumbers = () => {
      ...
      const renderEllipsis = (key: string) => (
        <span
          key={key}
          className="flex h-10 w-10 items-center justify-center rounded-none  border border-border bg-background text-muted-foreground text-xs -ml-px"
          aria-hidden="true"
        >
          ...
        </span>
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "flex flex-col sm:flex-row w-full items-center justify-between gap-4 text-xs sm:text-sm text-muted-foreground p-4 border-t border-border bg-[hsl(var(--table-header-bg))]",
          className
        )}
      >
        {/* Left: Info */}
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 lg:gap-8 order-1 sm:order-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="relative">
                <select
                  ...
                  disabled={isLoading}
                  className="h-9 w-[70px] appearance-none rounded-none  border border-border bg-background px-2 py-1 text-sm font-medium focus:outline-none focus:border-primary disabled:opacity-50 disabled:cursor-not-allowed hover-unified cursor-pointer"
                >
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="hidden sm:flex h-10 w-10 items-center justify-center rounded-none  border border-border bg-background hover-unified disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:border-primary z-10 cursor-pointer"
              aria-label="Go to first page"
            >
            ...
            <button
              ...
              disabled={currentPage === 0 || isLoading}
              className="flex h-10 w-10 items-center justify-center rounded-none  border border-border bg-background hover-unified disabled:opacity-50 focus:outline-none focus:border-primary z-10"
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-none  border border-border bg-background hover-unified disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:border-primary z-10"
