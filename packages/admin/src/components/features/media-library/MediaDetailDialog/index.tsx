  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-7xl w-full h-[80vh] p-0 flex flex-col gap-0 overflow-hidden bg-background shadow-2xl  border border-border sm:rounded-none">
          {/* 1. Header Row (Fixed Height) */}
          <div className="h-16  border-b border-border flex items-center justify-between px-6 bg-background shrink-0 z-10 w-full relative">
            ...
            <div className="flex items-center gap-2">
              <Button
                variant="outline"
                size="icon"
                className="h-8 w-8 rounded-none shadow-none hover-unified text-primary/80 border-border"
                onClick={onPrevious}
          ...
          <div className="flex-1 flex flex-row overflow-hidden min-h-0 bg-background w-full">
            ...
            <div
              className="flex-[0_0_35%] bg-background flex flex-col overflow-hidden h-full min-w-[320px]  border-l border-border"
              style={{ width: "35%", minWidth: "35%" }}
            >
              {/* Fixed Scrollable Area */}
              <div className="flex-1 overflow-y-auto px-6 py-6 scrollbar-thin">
                {/* Metadata Grid - Compact 2-column look */}
                <div className="grid grid-cols-2 gap-x-6 gap-y-4 text-[11px] text-muted-foreground  border-b border-border pb-4 mb-4">
              ...
              <div className="px-6 h-16  border-t border-border text-xs flex items-center justify-between shrink-0 bg-primary/5 mt-auto">
                <a
                  href={media.url}
                  target="_blank"
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className="h-8 text-xs font-semibold gap-2 border-border hover-unified"
                  >
