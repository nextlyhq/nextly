                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="mt-2 p-3  border border-border rounded-none flex items-center justify-between bg-primary/5">
                      ...
                      {form.watch("searchable") && (
                        <div className="flex items-center gap-2  border border-border rounded-none px-3 py-2 mt-2">
