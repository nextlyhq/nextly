      ...
      {!isSingle && (
        <div className="space-y-3 border-t border-border pt-6">
          ...
          {whereConditions.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-8 border border-dashed border-border rounded-none bg-muted/30">
            ...
            <div className="space-y-2">
              {whereConditions.map(condition => (
                <div
                  key={condition.id}
                  className="flex items-center gap-2 p-3 bg-muted/30 border border-border rounded-none"
                >
                  {/* Field name */}
                  <Input
          ...
          {params.where && (
            <div className="space-y-2">
              ...
              <code className="block text-xs bg-muted/30 px-3 py-2 border border-border rounded-none font-mono break-all text-muted-foreground">
                {params.where}
              </code>
            </div>
          )}
