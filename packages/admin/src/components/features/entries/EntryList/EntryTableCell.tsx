...
import { Avatar, AvatarFallback, AvatarImage, Badge } from "@nextlyhq/ui";
    ...
    if (isTitle && onEdit) {
      return (
        <button
          ...
          className="font-semibold text-foreground transition-colors text-left w-fit cursor-pointer"
        >
          {content}
        </button>
      );
