              ...
              <div className="grid grid-cols-4 gap-2">
                {selectedImages.map((image, index) => (
                  <div key={index} className="relative group">
                    <div className="aspect-square rounded-md overflow-hidden bg-primary/5">
                      <img
                        src={image.src}
                        alt={image.alt}
                    ...
                    <button
                      type="button"
                      className="absolute top-1 right-1 h-5 w-5 rounded-md bg-destructive-solid text-destructive-foreground flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
