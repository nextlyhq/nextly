      ...
      >
        ...
        {isHovered && (
          <button
            type="button"
            onClick={handleEdit}
            className="absolute top-0 right-0 bg-primary text-primary-foreground rounded-md p-1 shadow-md hover:bg-primary/90 transition-colors z-10 translate-x-1/4 -translate-y-1/4"
            title="Edit button"
          >
