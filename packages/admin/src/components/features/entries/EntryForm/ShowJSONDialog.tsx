    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent size="xl" className="max-h-[80vh] flex flex-col">
        ...
        <div className="flex items-center gap-4 py-2 border-b border-border">
          ...
          {/* API URL display */}
          <code className="flex-1 text-xs text-muted-foreground truncate font-mono bg-muted px-2 py-1 rounded">
            GET {apiUrl}
          </code>
        ...
        {/* JSON content area */}
        <div className="flex-1 overflow-auto min-h-[300px] rounded-md border border-border bg-muted/50">
          {isLoading ? (
