...
export function MobileSidebarDrawer({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        {/* Header */}
        <SheetHeader className="flex flex-row h-16 items-center justify-between gap-3 px-6  border-b border-border border-sidebar-border space-y-0 text-left">
          ...
          <SheetClose className="rounded-md opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2">
