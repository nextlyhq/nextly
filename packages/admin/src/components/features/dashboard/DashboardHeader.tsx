    ...
    <header className="sticky top-0 z-30 shrink-0 hidden lg:flex h-16 items-center justify-end  border-b border-border bg-background backdrop-blur-md px-4 sm:px-8">
      ...
      <div className="flex items-center gap-2 hidden">
        <button
          ...
          className="inline-flex h-9 w-9 items-center justify-center rounded-md  border border-border bg-background text-muted-foreground transition-colors hover:bg-accent hover:text-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring cursor-pointer"
