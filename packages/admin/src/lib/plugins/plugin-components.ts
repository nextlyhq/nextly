 ...
 *   registerComponents({
 *     '@nextlyhq/plugin-foo/admin#FooView': FooView,
 *     '@nextlyhq/plugin-foo/admin#FooButton': FooButton,
 *   });
 * }
 * ```
 *
 ...
 * import { registerFormBuilderComponents } from '@nextlyhq/admin/lib/plugin-components';
 *
 ...
 *
 * @param pluginName - The plugin package name (e.g., '@nextlyhq/plugin-foo')
