 ...
 * - CollectionRegistryService: Unified registry for code-first and UI collections
 * - CollectionSyncService: Sync code-first collections from config to database
 ...
 * - CollectionExportService: Export UI collections to code-first format
 *
