...
// Re-exported here so existing consumers and relations() blocks below keep working
// until Task 16 sweeps imports to @nextly/schemas.
export { auditLog, activityLog } from "../../schemas/audit/sqlite";
import { auditLog, activityLog } from "../../schemas/audit/sqlite";
...
// Media tables — moved to schemas/media/sqlite.ts (Plan A Task 8).
// Re-exported here so existing consumers and relations() blocks below keep working
// until Task 16 sweeps imports to @nextly/schemas.
export { media, mediaFolders, imageSizes } from "../../schemas/media/sqlite";
import { media, mediaFolders, imageSizes } from "../../schemas/media/sqlite";
...
// mediaFolders moved to schemas/media/sqlite.ts (Plan A Task 8) and re-exported
...
// imageSizes moved to schemas/media/sqlite.ts (Plan A Task 8) and re-exported
// with the rest of the media tables above.
