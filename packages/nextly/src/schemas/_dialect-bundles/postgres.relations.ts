 ...
 * `<feature>/postgres-relations.ts` files (drizzle v1 removed the
 ...
 *
 * @module schemas/_dialect-bundles/postgres.relations
 */
...
type PostgresTables = ExtractTablesFromSchema<typeof tables>;

export const buildPostgresEdges = (r: RelationsBuilder<PostgresTables>) => ({
  users: {
...
export const relations = defineRelations(tables, buildPostgresEdges);
