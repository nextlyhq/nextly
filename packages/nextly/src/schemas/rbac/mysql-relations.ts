/**
 * Drizzle `relations()` declarations for the RBAC tables — MySQL.
 *
 * Mirror of `postgres-relations.ts` for the MySQL dialect. See that file
 * for the rationale behind the separate-file split.
 *
 * @module schemas/rbac/mysql-relations
