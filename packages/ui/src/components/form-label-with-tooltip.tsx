          ...
          <TooltipProvider>
            <Tooltip delayDuration={200}>
              ...
              <TooltipContent
                side="right"
                className={cn(
                  "max-w-[250px] text-[12px] break-words relative z-[100] shadow-md  border border-border bg-black text-white dark:bg-zinc-800 dark:text-zinc-50 px-3 py-2 rounded-none",
                  tooltipClassName
                )}
              >
                {description}
