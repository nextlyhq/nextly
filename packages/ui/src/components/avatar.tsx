...
export const avatarVariants = cva(
  "relative inline-flex shrink-0 overflow-hidden rounded-md items-center justify-center bg-primary/5 text-muted-foreground",
  {
    variants: {
      size: {
        sm: "h-8 w-8",
  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <AvatarFallbackPrimitive
        ...
        className={cn(
          "bg-primary/5 text-muted-foreground flex size-full items-center justify-center rounded-md font-medium",
          textSize,
          className
        )}
        {...props}
