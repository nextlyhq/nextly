...
| --- | ------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------------------------- | --------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| A   | Table & list consistency: pagination gap, search field, filters, columns, sorting, headers, CTAs, skeletons, empty states | in-progress | `task-09/subtask-1-table-consistency-audit` | Audit first, fix after sign-off                                       | Renderer is already shared (16 surfaces on `DataTableView`); the SHELL is duplicated. See below |
