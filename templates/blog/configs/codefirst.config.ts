...
// src/collections/ and src/singles/ to add, remove, or modify fields.
//
...
import { Navigation } from "./src/singles/Navigation";
import { SiteSettings } from "./src/singles/SiteSettings";
